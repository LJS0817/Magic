<div align="center">
  <h1>🪄 Magic - 마법진 드로잉 및 판매 게임</h1>
  <p><strong>헥사곤 던전을 돌파하여 재료를 얻거나 마우스로 직접 마법진(도형)을 그려 판매하는 마법 상점 운영 게임</strong></p>
...
3. **AP(Action Point) 기반 헥사곤 탐색 시스템:**
   Cost 기반의 헥스 패스파인딩(Hex Pathfinding)을 적용해 AP 안에서 이동 가능한 범위를 시각화하고, 타일 미리보기(Peek) 기능을 통해 던전 탐험의 전략성을 극대화했습니다.
