...
public class EnemyController : MonoBehaviour
{
    ...
    public StatusEffectContainerUI statusEffectUI;
    ...
    public void OnTurnEnd()
    {
        ...
        if (statusEffectUI != null) statusEffectUI.UpdateEffects(activeEffects);
    }
    ...
    public void Spawn(float healthMultiplier = 1f, float damageMultiplier = 1f)
    {
        // Load data from SO if available
        if (enemyData != null)
        {
            maxHealth = enemyData.maxHealth * healthMultiplier;
            attackDamage = enemyData.attackDamage * damageMultiplier;
            currentAttackElement = enemyData.defaultAttackElement;
    ...
    private void Die()
    {
        ...
        if (InventoryManager.Instance != null)
        {
            ...
            {
                float dropBonus = UpgradeManager.Instance.GetTotalUpgradeValue(UpgradeType.DropRateBonus);
